...
import com.jkmaks.database.AllClassDB;
...
public class StartingFragment extends Fragment {
    ...
    public void updateEventDB(String campus_name, String the_html, EventDB edb) {
        ...
        ArrayList<Event> new_events = he.extractEvent(the_html);
    ...
    public void doQuarterUpdate() {
        ...
        HashMap<String, String> quarters = he.extractQuarters(html, activity);
    ...
    private String extractEventHTML(String the_address) {
        EventXML_Getter jg = new EventXML_Getter();
